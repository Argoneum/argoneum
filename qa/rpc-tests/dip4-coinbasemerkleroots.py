#!/usr/bin/env python3
# Copyright (c) 2015-2018 The Argoneum Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
from collections import namedtuple

from test_framework.mininode import *
from test_framework.test_framework import ArgoneumTestFramework
...
class LLMQCoinbaseCommitmentsTest(ArgoneumTestFramework):
    def __init__(self):
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as ArgoneumTestFramework doesn't support this atm)
