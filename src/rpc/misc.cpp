...
UniValue debug(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "argoneum|privatesend|instantsend|masternode|spork|keepass|mnpayments|gobject )\n"
...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress \"argoneumaddress\"\n"
            "\nReturn information about the given argoneum address.\n"
            "\nArguments:\n"
            "1. \"argoneumaddress\"     (string, required) The argoneum address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,       (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"argoneumaddress\", (string) The argoneum address validated\n"
...
UniValue verifymessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage \"argoneumaddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"
            "\nArguments:\n"
            "1. \"argoneumaddress\"  (string, required) The argoneum address to use for the signature.\n"
