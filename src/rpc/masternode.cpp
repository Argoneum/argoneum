...
void masternode_list_help()
{
    throw std::runtime_error(
            ...
            "  owneraddress   - Print the masternode owner Argoneum address\n"
            "  payee          - Print the masternode payout Argoneum address (can be additionally filtered,\n"
            "                   partial match)\n"
            ...
            "  votingaddress  - Print the masternode voting Argoneum address\n"
        );
}
