...
2. run argoneumd with -printalert or -sendalert like this:
   /path/to/argoneumd -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.argoneum.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/Argoneum Core:0.12.0.58/"));
