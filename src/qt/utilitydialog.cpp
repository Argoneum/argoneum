    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Argoneum Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Argoneum Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  argoneum-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Argoneum in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 AGM, 0.1 AGM, 1 AGM and 10 AGM -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://argoneum.atlassian.net/wiki/display/DOC/PrivateSend\">https://argoneum.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Argoneum Core is shutting down...") + "<br /><br />" +
