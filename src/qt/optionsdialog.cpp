    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("Argoneum-light"), QVariant("light"));
    // ui->theme->addItem(QString("Argoneum-light-hires"), QVariant("light-hires"));
    // ui->theme->addItem(QString("Argoneum-blue"), QVariant("drkblue"));
    // ui->theme->addItem(QString("Argoneum-Crownium"), QVariant("crownium"));
    // ui->theme->addItem(QString("Argoneum-traditional"), QVariant("trad"));
