    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("AGM-light"), QVariant("light"));
    ui->theme->addItem(QString("AGM-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("AGM-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("AGM-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("AGM-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("AGM-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("AGM-traditional"), QVariant("trad"));
