    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Argoneum Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Argoneum address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and argoneum: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Argoneum Core"), this);
    aboutAction->setStatusTip(tr("Show information about Argoneum Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Argoneum Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Argoneum addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Argoneum addresses"));
    ...
    openAction->setStatusTip(tr("Open a argoneum: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Argoneum Core help message to get a list with possible Argoneum Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Argoneum Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Argoneum network", "", count));
    } else {
...
{
    QString strTitle = tr("Argoneum Core"); // default title
