# Linearize
Construct a linear, no-fork, best version of the Argoneum blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install argoneum_hash

https://github.com/argoneum/argoneum_hash
...
JSON-RPC server. Running `argoneumd` or `argoneum-qt -server` will be sufficient.
...
* `input`: argoneumd blocks/ directory containing blkNNNNN.dat
