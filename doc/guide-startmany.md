...
Copy the masternode private key and corresponding collateral output transaction that holds the 1000 AGM.

*Note: The masternode private key is **not** the same as a wallet private key. **Never** put your wallet private key in the masternode.conf file. That is almost equivalent to putting your 1000 AGM on the remote server and defeats the purpose of a hot/cold setup.*
...
[From the argoneum github repo](https://github.com/argoneum/argoneum/blob/master/doc/masternode_conf.md)
...
If you generated a new masternode private key, you will need to update the remote `argoneum.conf` files.
...
```
argoneum-cli masternode status
{
...
Search your Masternodes on https://argoneumninja.pl/masternodes.html
