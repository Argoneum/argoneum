...
* Update translations, see [translation_process.md](https://github.com/argoneum/argoneum/blob/master/doc/translation_process.md#syncing-with-transifex)
...
### Build and sign Argoneum Core for Linux, Windows, and OS X:
	...
	./bin/gbuild --commit argoneum=v${VERSION} ../argoneum/contrib/gitian-descriptors/gitian-linux.yml
	...
	./bin/gbuild --commit argoneum=v${VERSION} ../argoneum/contrib/gitian-descriptors/gitian-win.yml
	...
	./bin/gbuild --commit argoneum=v${VERSION} ../argoneum/contrib/gitian-descriptors/gitian-osx.yml
...
### Verify other gitian builders signatures to your own. (Optional)
  ...
  Add other gitian builders keys to your gpg keyring
	...
	gpg --import ../argoneum/contrib/gitian-downloader/*.pgp
...
- Announce the release:
  ...
  - Argoneum-development mailing list

  - Update title of #argoneumpay on Freenode IRC

  - Optionally reddit /r/Argoneumpay, ... but this will usually sort out itself
