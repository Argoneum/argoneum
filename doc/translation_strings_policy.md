...
This document provides guidelines for internationalization of the Argoneum Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `argoneum_en.ts` remains unchanged.
