...
This mechanism has been integrated into Bitcore-Node-Argoneum which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/argoneum/insight-api-argoneum#web-socket-api](https://github.com/argoneum/insight-api-argoneum#web-socket-api)
* API: [https://github.com/argoneum/insight-api-argoneum#instantsend-transactions](https://github.com/argoneum/insight-api-argoneum#instantsend-transactions)
...
By default, the Argoneum Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Argoneum Core daemon:
