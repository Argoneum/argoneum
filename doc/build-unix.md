...
-----------------------
Building the dependencies and Argoneum Core requires some essential build tools and libraries to be installed before.
...
Add `CC=egcc CXX=eg++ CPP=ecpp` to the dependencies build and the Argoneum Core build:
```bash
$ cd depends
