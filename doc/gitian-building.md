...
in the Argoneum Core repository under 'Fetch and create inputs' to install sources which require
...
BTCPATH=/some/root/path/argoneum
SIGPATH=/some/root/path/argoneum-detached-sigs
