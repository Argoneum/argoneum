...
Only requiring some minor changes is argoneum.cpp.
...
Changes to argoneum.cpp
----------------------
argoneum.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
